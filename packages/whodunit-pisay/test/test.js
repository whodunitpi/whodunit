...
console.log(pisay(chalk.red('WHAT DOES THE YO SAY??? ') + chalk.yellow('\'ALLO \'ALLO')));

describe('@whodunit/pisay', () => {
  // New test template.
  //
  // it('should _____', function (done) {
  //   var testName = 'short-description';
  //   var expected = pisay('String to test');
  //
  ...
  it('should return correctly formatted string in two lines', done => {
    ...
    const expected = pisay('Welcome to whodunit, ladies and gentlemen!');
  ...
  it('should allow customization of line length', done => {
    ...
    const expected = pisay('Hi', {maxLength: 8});
  ...
  it('should override a maxLength setting that is too short', done => {
    ...
    const expected = pisay('Hello, buddy!', {maxLength: 4});
  ...
  describe('ansi', () => {
    it('should display ansi styling correctly', done => {
      const testName = 'ansi';
      const expected = pisay(chalk.red.bgWhite('Hi'));
    ...
    it('should handle part ansi and part not-ansi', done => {
      ...
      const expected = pisay(chalk.red.bgWhite('Hi') + ' there, sir!');
    ...
    it('should wrap ansi styling to the next line properly', done => {
      ...
      const expected = pisay(chalk.red.bgWhite('Hi') + ' there, sir! ' + chalk.bgBlue.white('you are looking') + ' swell today!');
    ...
    it('should handle new line properly', done => {
      ...
      const expected = pisay('first line\nsecond line\n\nfourth line');
    ...
    it('should display long words correctly', done => {
      ...
      const expected = pisay('iloveunicornsiloveunicornsiloveunicornsiloveunicornsiloveunicornsiloveunicorns');
    ...
    it('should overflow when lines exceed the default greeting', done => {
      ...
      const expected = pisay('Lie on your belly and purr when you are asleep shove bum in owner’s face like camera lens. Cough furball.', {maxLength: 11});
