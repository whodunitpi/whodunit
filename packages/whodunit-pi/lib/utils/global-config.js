...
const globalConfigPath = path.join(os.homedir(), '.pi-rc-global.json');
...
/**
 * Return the content from `.pi-rc-global.json` as JSON object.
 ...
 * @param  {String} name The investigator which will be deleted
 */
